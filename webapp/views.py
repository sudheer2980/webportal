...
def contributor_profile_subject(request,contri_username,class_num):
	...
	context_dict = {'uploads': uploads, 'class_num':class_num,'contri_username':contri_username,'contributor':contributor}
...
def contributor_profile_topic(request,contri_username,class_num,sub):
	...
	context_dict = {'uploads': uploads, 'class_num':class_num, 'sub':sub,'contri_username':contri_username,'contributor':contributor}
